...
//    MY    call python method "create_from_ui" from pos.order
        return posOrderModel.call('create_from_ui',
            [_.map(orders, function (order) {
                order.to_invoice = options.to_invoice || false;
                console.log(order)
                console.log("create_from_ui")
                return order;
            })],
            undefined,
            {
...
exports.Order = Backbone.Model.extend({
    ...
    set_screen_data: function(key,value){
    	console.log(key)
    	console.log(value)
    	console.log(this.screen_data[key])
...
exports.NumpadState = Backbone.Model.extend({
    ...
    appendNewChar: function(newChar) {
        ...
        console.log(this.trigger('set_value',this.get('buffer')));
    },
