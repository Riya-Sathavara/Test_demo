...
var PosDB = core.Class.extend({
    ...
    get_partner_by_id: function(id){
    	console.log(this.partner_by_id[id])
...
//    	display selected product na all that product details
//    	console.log(this.product_by_id[qty_available])
