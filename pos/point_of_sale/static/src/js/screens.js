...
//    number box right for all number action
	template:'NumpadWidget',
    init: function(parent) {
        this._super(parent);
        this.state = new models.NumpadState();
        console.log("NumpadWidget");
    },
    
    start: function() {
    	console.log("NumpadWidget_inint")
        this.state.bind('change:mode', this.changedMode, this);
    	console.log("changemodecalll")
        this.changedMode();
...
var OrderWidget = PosBaseWidget.extend({
    ...
    init: function(parent, options) {
        ...
        this.line_click_handler = function(event){
            ...
            console.log(this.line_click_handler)
        };
...
var ProductCategoriesWidget = PosBaseWidget.extend({
    ...
    init: function(parent, options){
    	console.log("ProductCategoriesWidget");
        var self = this;
        this._super(parent,options);
...
var ProductScreenWidget = ScreenWidget.extend({
    ...
    start: function(){ 
        ...
        var self = this;
        console.log("ProductScreenWidget116165661 start");
        ...
        console.log("ProductScreenWidget");
    },

    click_product: function(product) {
    	console.log(product.qty_available)
//    	click on product add paymernt
...
var ClientListScreenWidget = ScreenWidget.extend({
    ...
    has_client_changed: function(){
    	console.log("has_client_changed")
...
//    	selectd customer id and mouseevent
    	console.log(event)
    	console.log($line)
    	console.log(id)
        var partner = this.pos.db.get_partner_by_id(id);
//    	selected partner all address or email ext data
    	console.log(partner)
...
var PaymentScreenWidget = ScreenWidget.extend({
    ...
    renderElement: function() {
        ...
        this.$('.next').click(function(){
        	console.log("click on validate button")
            self.validate_order();
        });
        ...
        this.$('.js_invoice').click(function(){
        	console.log("click on invoice button")
            self.click_invoice();
        });
