...
class pos_order(osv.osv):
    ...
    def _process_order(self, cr, uid, order, context=None):
        ...
        print"____________order_id ", order_id
        journal_ids = set()
    ...
    def create_from_ui(self, cr, uid, orders, context=None):
        ...
        print"\n \n \n \n \n \n n\n submitted_references", submitted_references
...
#         print"\n \n \n \n create_picking_____________________________________"
#         picking_obj = self.pool.get('stock.picking')
#         partner_obj = self.pool.get('res.partner')
...
#                     continue
#                 print"n \n \n \n move________________________________"
...
#         return True
    ...
    def action_invoice(self, cr, uid, ids, context=None):
        print"\n \n \n \n action_invoice_____________________________________"
